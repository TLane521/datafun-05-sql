"""tamara_duckdb_shelter.py - Project script (example).
...
ADOPITION_CSV: Final[Path] = DATA_DIR / "adoption.csv"
...
def main() -> None:
    ...
    try:
        ...
        # ----------------------------------------------------
        run_sql_script(con, SQL_DIR / "tamara_shelter_clean.sql")

        # ----------------------------------------------------
        # STEP 2: BOOTSTRAP (create tables, load CSV data)
        # ----------------------------------------------------
        run_sql_script(con, SQL_DIR / "tamara_shelter_bootstrap.sql")
